...
<head>
	...
	<link rel="stylesheet" href="css/bootstrap.datetimepicker.css?v=<?php echo time(); ?>">
	<link rel="stylesheet" href="//cdn.datatables.net/1.10.7/css/jquery.dataTables.css?v=<?php echo time(); ?>">
	<link rel="stylesheet" href="//cdn.datatables.net/plug-ins/1.10.7/integration/bootstrap/3/dataTables.bootstrap.css?v=<?php echo time(); ?>">
